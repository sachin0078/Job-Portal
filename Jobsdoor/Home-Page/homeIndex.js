...
var BenefitsreviewButton = document.getElementById("explore1");

BenefitsreviewButton.addEventListener("click", () => {
    window.location = 'BenefitsReview.html';
});

var RateaCompanyButton = document.getElementById("explore2");

RateaCompanyButton.addEventListener("click", () => {
    window.location = 'rateacompany.htm';
});

var salaryButton = document.getElementById("explore3");

salaryButton.addEventListener("click", () => {
    window.location = 'Salaries/Salaries.htm';
});

var InterviewReviewButton = document.getElementById("explore4");

InterviewReviewButton.addEventListener("click", () => {
    window.location = 'InterviewReview.htm';
});

var AddasalaryButton = document.getElementById("explore5");

AddasalaryButton.addEventListener("click", () => {
    window.location = 'Add_a_Salary.htm';
});
...
locBox.oninput = function(e) {
 ...
 roles.push(new addRole("Junior Full Stack Developer", "Dreamz Interactive", "Chandigarh", 1, "non"));
 roles.push(new addRole("Junior Full Stack Developer", "Dreamz Interactive", "Chandigarh", 2, "non"));
 roles.push(new addRole("Java Full Stack", "IBM", "Chandigarh", 3, "https://media.glassdoor.com/sql/354/ibm-squareLogo-1626088539071.png"));
 roles.push(new addRole("Sr. Full Stack Developer", "Digital Avenues Pvt. Ltd.", "Chandigarh", 9, "non"));
...
finButton.addEventListener('click', function() {
    window.location = "Finish-Profile.html";
})
